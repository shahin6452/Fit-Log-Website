...
const ExcerciseCardDetail = async ({ params }) => {
    ...
    return (
        <div className='bg-[#0F1115] py-10'>
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 container mx-auto">
                ...
                <div>
                    ...
                    <div className='bg-[#1E2330] rounded-3xl'>
                        <div className="overflow-hidden rounded-lg border border-[#1c2025] p-3">
                            ...
                            <div className="flex justify-between border-b border-[#1c2025] px-4 py-3 text-xs">
                                <span className="uppercase text-gray-200">Equipment</span>
                                <span className="text-gray-200">{equipment}</span>
                            </div>

                            <div className="flex justify-between border-b border-[#1c2025] px-4 py-3 text-xs">
                                <span className="uppercase text-gray-200">Difficulty</span>
                                <span className="text-gray-200">{difficulty}</span>
                            </div>

                            <div className="flex justify-between border-b border-[#1c2025] px-4 py-3 text-xs">
                                <span className="uppercase text-gray-200">Sets</span>
                                <span className="text-gray-200">{sets}</span>
                            </div>

                            <div className="flex justify-between border-b border-[#1c2025] px-4 py-3 text-xs">
                                <span className="uppercase text-gray-200">Reps</span>
                                <span className="text-gray-200">{reps}</span>
                            </div>

                            <div className="flex justify-between border-b border-[#1c2025] px-4 py-3 text-xs">
                                <span className="uppercase text-gray-200">Duration</span>
                                <span className="text-gray-200">{duration}</span>
                            </div>

                            <div className="flex justify-between border-b border-[#1c2025] px-4 py-3 text-xs">
                                <span className="uppercase text-gray-200">Calories</span>
                                <span className="text-gray-200">{caloriesBurned}</span>
                            </div>

                            <div className="flex justify-between px-4 py-3 text-xs">
                                <span className="uppercase text-gray-200">Rating</span>
                    ...
                    <div className="mt-6">
                        ...
                        <ol className="list-decimal pl-5 space-y-2 text-xs leading-5 text-gray-400">
                            {
                                instructions.map((instruction, ind) => <li key={ind}>{instruction}</li>)
                            }
                        </ol>
                    ...
                    <div className="mt-6 flex gap-3">
                        ...
                        <button className="btn h-10 min-h-0 border-0 bg-[#C2F800] px-4 text-xs font-semibold text-black hover:bg-[#b5eb00]">
                            <CalendarPlus size={16} strokeWidth={2} />
                            Add to today's plan
                        </button>

                        <button className="btn h-10 min-h-0 border border-[#292d32] bg-transparent px-4 text-xs font-semibold text-gray-400 hover:bg-[#15181c]">
